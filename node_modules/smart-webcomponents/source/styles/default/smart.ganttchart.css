...
.smart-gantt-chart smart-splitter:not([orientation="horizontal"]).transition-scroll-bars smart-splitter-bar {
...
.smart-gantt-chart smart-tree[selection-mode="checkBox"] smart-tree-items-group > .smart-tree-item-label-container, .smart-gantt-chart smart-tree[selection-mode="radioButton"] smart-tree-item,
...
.smart-gantt-chart .smart-splitter-item[sort] .smart-task-tree-content,
.smart-gantt-chart .smart-splitter-item[sort] .smart-resource-tree-content {
    background: var(--smart-grid-cell-background-sort);
    color: var(--smart-grid-cell-color-sort);
}

.smart-gantt-chart .smart-splitter-item[sort="asc"] .smart-task-tree-header:after,
.smart-gantt-chart .smart-splitter-item[sort="asc"] .smart-resource-tree-header:after {
    transform: rotate(180deg) scale(1);
}

.smart-gantt-chart .smart-splitter-item[sort="desc"] .smart-task-tree-header:after,
.smart-gantt-chart .smart-splitter-item[sort="desc"] .smart-resource-tree-header:after {
...
.smart-gantt-chart .smart-tree-splitter smart-tree-items-group[assigned] > .smart-tree-item-label-container {
    /*border-color: rgba(var(--smart-primary-rgb), .05);*/
...
.smart-gantt-chart .smart-timeline-cells-container:empty {
    min-height: 1px;
}
...
.smart-gantt-chart .smart-timeline-animation-container .smart-timeline-task:after, .smart-gantt-chart .smart-timeline-animation-container .smart-timeline-task:before {
    content: ' ';
    position: absolute;
    width: 100%;
    border-top: var(--smart-border-width) solid var(--smart-border);
...
.smart-gantt-chart .smart-resource-splitter {
    --smart-splitter-bar-fit-size: calc(var(--smart-gantt-chart-resource-timeline-content-height) + var(--smart-gantt-chart-task-default-height));
}
...
.smart-gantt-chart .smart-resource-tree-header:after {
    content: "";
    position: absolute;
    right: 2.5%;
...
.smart-gantt-chart .smart-resource-tree-header > div {
    overflow: hidden;
    text-overflow: ellipsis;
    white-space: nowrap;
    pointer-events: none;
...
.smart-gantt-chart .smart-resource-label-container[hover], .smart-gantt-chart .smart-resource-label-container[hover] {
    border-color: var(--smart-ui-state-border-hover);
    background-color: var(--smart-ui-state-hover);
    color: var(--smart-ui-state-color-hover);
}

.smart-gantt-chart .smart-resource-label-container[selected], .smart-gantt-chart .smart-resource-label-container[selected] {
...
.smart-gantt-chart .smart-task-tree-header:after {
    content: "";
    position: absolute;
    right: 2.5%;
    content: var(--smart-icon-arrow-down);
...
.smart-gantt-chart .smart-task-tree-header > div {
    overflow: hidden;
    text-overflow: ellipsis;
    white-space: nowrap;
    pointer-events: none;
...
.smart-gantt-chart .smart-task-splitter-item[show-header] .smart-resource-splitter {
    height: calc(100% - var(--smart-gantt-chart-header-height));
}
...
.smart-gantt-chart .smart-task-label-container[hover], .smart-gantt-chart .smart-task-label-container[hover] {
    border-color: var(--smart-ui-state-border-hover);
    background-color: var(--smart-ui-state-hover);
    color: var(--smart-ui-state-color-hover);
}

.smart-gantt-chart .smart-task-label-container[selected], .smart-gantt-chart .smart-task-label-container[selected] {
    border-color: var(--smart-ui-state-border-selected);
    background-color: var(--smart-ui-state-selected);
    color: var(--smart-ui-state-color-selected);
}
...
.smart-gantt-chart:not([animation="none"]) .smart-resource-timeline-view-cell[load]:after {
    transition: transform 0.2s cubic-bezier(0.4, 0, 0.6, 1), border-radius 0.2s cubic-bezier(0.4, 0, 0.6, 1), background 0.2s cubic-bezier(0.4, 0, 0.6, 1), color 0.2s cubic-bezier(0.4, 0, 0.6, 1);
}
...
.smart-gantt-chart:not([animation="none"]) .smart-task-tree-header:after {
    transition: transform .2s ease-out, opacity .2s ease-out;
}
...
.smart-gantt-chart:not([animation="none"]) .smart-timeline-task.task .smart-timeline-task-label {
    transition: color 0.2s ease-in-out;
}

.smart-gantt-chart:not([animation="none"]) .smart-timeline-task.project .smart-timeline-task-label {
    transition: color 0.2s ease-in-out;
}
...
.smart-gantt-chart[animation="none"] .smart-timeline-view-cells:not([no-transition]) .smart-timeline-view-cell::after {
    transition: height 0.2s ease-in;
}

.smart-gantt-chart.vscroll .smart-timeline {
    width: calc(100% - var(--smart-scroll-bar-size));
}

.smart-gantt-chart[sortable] .smart-task-tree-header,
.smart-gantt-chart[sortable] .smart-resource-tree-header {
    padding: 0 var(--smart-font-size) 0 var(--smart-font-size);
}
...
.smart-gantt-chart[hide-timeline-header-details] .smart-task-splitter-item:not([show-header]) .smart-timeline-view-cell {
    border-top: none;
}

.smart-gantt-chart[hide-timeline-header-details] .smart-timeline-view-cells,
.smart-gantt-chart[hide-timeline-header-details] .smart-task-tree-header {
    height: var(--smart-gantt-chart-task-default-height);
}

.smart-gantt-chart[hide-timeline-header-details] .smart-task-splitter {
    --smart-gantt-chart-splitter-bar-fit-size: calc(var(--smart-gantt-chart-task-timeline-content-height) + var(--smart-gantt-chart-task-default-height));
}

.smart-gantt-chart[hide-timeline-header-details] .smart-timeline-animation-container {
    height: calc(100% - var(--smart-gantt-chart-task-default-height));
}

.smart-gantt-chart[hide-timeline-header-details] .smart-task-tree-content {
    height: calc(100% - var(--smart-gantt-chart-task-default-height));
}

.smart-gantt-chart[hide-timeline-header-details] .smart-timeline-content {
    height: calc(100% - var(--smart-gantt-chart-task-default-height));
}

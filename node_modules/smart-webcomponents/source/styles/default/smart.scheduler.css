...
smart-scheduler .smart-scheduler-view-header-horizontal .smart-scheduler-view-header-horizontal-content {
  width: 100%;
  height: 100%;
  position: relative;
  overflow: hidden;
...
smart-scheduler[disable-date-menu] .smart-scheduler-view-items-button:after {
  content: initial;
}
